...
<body>
 ...
 <?php
  ...
  ?>
      <form action="./updatecategory?ca_id=<?php echo $row->ca_id ?>" method="POST" enctype="multipart/form-data">
 
  <div class="form-group">
    <label for="exampleInput">Category name</label>
    <input name="ca_name" type="text" class="form-control" id="exampleInput" value="<?php echo $row->ca_name ?>">
  </div>
